...
import {TrendingDown, BarChart3, Activity, Download, RefreshCw} from 'lucide-react'
...
export const AnalyticsOverview: React.FC<AnalyticsOverviewProps> = ({className}) => {
	...
	const {data: analytics, isLoading, error, refetch} = useCredentialAnalytics(currentQuery)
			...
			<CardHeader>
				<div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
					<div>
						...
						<CardDescription>Comprehensive analytics for your credential activities</CardDescription>
					</div>
					<div className='flex gap-2'>
						...
						<Select value={selectedPeriod} onValueChange={(value) => setSelectedPeriod(value as keyof ReturnType<typeof getAnalyticsQueryPresets>)}>
										...
										<CardContent className='p-6'>
											<div className='flex items-center justify-between'>
												<div>
													...
													<div className='text-3xl font-bold text-blue-600'>{analytics.issuance_metrics.total_issued}</div>
												</div>
												<div className='p-3 bg-blue-50 rounded-full'>
													<BarChart3 className='h-6 w-6 text-blue-600' />
												</div>
											</div>
											<p className='text-xs text-muted-foreground mt-2'>+{analytics.issuance_metrics.issued_this_month} this month</p>
										</CardContent>
									</Card>
										...
										<CardContent className='p-6'>
											<div className='flex items-center justify-between'>
												<div>
													...
													<div className='text-3xl font-bold text-green-600'>{analytics.received_metrics.total_received}</div>
												</div>
												<div className='p-3 bg-green-50 rounded-full'>
													<Download className='h-6 w-6 text-green-600' />
												</div>
											</div>
											<p className='text-xs text-muted-foreground mt-2'>+{analytics.received_metrics.received_this_month} this month</p>
										</CardContent>
									</Card>
										...
										<CardContent className='p-6'>
											<div className='flex items-center justify-between'>
												<div>
													...
													<div className='text-3xl font-bold text-red-600'>{analytics.overview_metrics.revoked_credentials}</div>
												</div>
												<div className='p-3 bg-red-50 rounded-full'>
													<TrendingDown className='h-6 w-6 text-red-600' />
												</div>
											</div>
											<p className='text-xs text-muted-foreground mt-2'>{analytics.status_metrics.revoked_credentials.revoked_this_month} this month</p>
										</CardContent>
									</Card>
										...
										<CardContent className='p-6'>
											<div className='flex items-center justify-between'>
												<div>
													...
													<div className='text-3xl font-bold text-emerald-600'>{analytics.overview_metrics.active_credentials}</div>
												</div>
												<div className='p-3 bg-emerald-50 rounded-full'>
													<Activity className='h-6 w-6 text-emerald-600' />
												</div>
											</div>
											<p className='text-xs text-muted-foreground mt-2'>{analytics.status_metrics.active_credentials.expiring_within_30_days} expiring soon</p>
										</CardContent>
									</Card>
								</div>
										...
										<CardContent>
											<div className='space-y-2'>
												<div className='flex justify-between'>
													<span>Active</span>
													<span className='font-medium text-green-600'>{analytics.status_metrics.active_credentials.count}</span>
												</div>
												<div className='flex justify-between'>
													<span>Revoked</span>
													<span className='font-medium text-red-600'>{analytics.status_metrics.revoked_credentials.count}</span>
												</div>
												<div className='flex justify-between'>
													<span>Deactivated</span>
													<span className='font-medium text-orange-600'>{analytics.status_metrics.deactivated_credentials.count}</span>
												</div>
											</div>
										</CardContent>
									</Card>
										...
										<CardContent>
											<div className='space-y-2'>
												...
												<div className='flex justify-between'>
													...
													<span className='font-medium text-green-600'>{analytics.received_metrics.verification_success_rate.toFixed(1)}%</span>
												</div>
											</div>
										</CardContent>
									</Card>

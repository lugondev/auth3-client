/**
 * Presentations Components Export Index
 */
...
export { PresentationVerificationResults } from './PresentationVerificationResults'

// UI Components
export { PresentationStatusBadge } from './PresentationStatusBadge'
...
// VP-002 Enhanced Sharing Components
export { default as SharingOptions } from './SharingOptions'
export { default as PresentationQRCode } from './PresentationQRCode'
export { default as ShareHistory } from './ShareHistory'

// VP-003 Advanced Features

...
import {Chrome, Apple, Twitter} from 'lucide-react' // Added Twitter

export function LoginButtons() {
	const {signInWithGoogle, signInWithApple, signInWithTwitter, loading} = useAuth() // Added signInWithTwitter

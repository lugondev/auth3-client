		...
		<div className='min-h-screen bg-background flex items-center justify-center p-4'>
			<Card className='w-full max-w-md'>
				<CardHeader className='text-center'>
					...
					<CardDescription className='text-muted-foreground'>You don&#39;t have permission to access {requestedPath}</CardDescription>
				</CardHeader>

				<CardContent className='space-y-6'>
					{/* Error Details */}
					<div className='bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800/30 rounded-lg p-4'>
						<h4 className='text-sm font-medium text-red-800 dark:text-red-400 mb-2'>Reason</h4>
						<p className='text-sm text-red-700 dark:text-red-300 capitalize'>{reason}</p>
					</div>

					{/* User Info */}
					{user && (
						<div className='bg-muted/50 border border-border rounded-lg p-4'>
							<h4 className='text-sm font-medium text-foreground mb-2'>Current User</h4>
					...
					<div className='bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg p-4'>
						<h4 className='text-sm font-medium text-blue-800 dark:text-blue-400 mb-2'>What you can do:</h4>

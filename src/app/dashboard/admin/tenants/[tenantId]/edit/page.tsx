...
export default function EditTenantPage() {
	...
	const deleteTenantMutation = useMutation({
		...
		onSuccess: () => {
			...
			router.push('/dashboard/admin/tenants') // Redirect after successful deletion
		},
		onError: (error: Error) => {
	...
	if (!tenant) {
		return (
			<div className='container mx-auto p-4 text-center'>
				<PageHeader title='Tenant Not Found' description='The requested tenant could not be found.' backButton={{text: 'Back to Tenants List', href: '/dashboard/admin/tenants'}} />
			</div>
		)
	}
	...
	return (
		<div className='container mx-auto p-4 space-y-8'>
			<PageHeader title={`Edit Tenant: ${tenant.name}`} backButton={{text: 'Back to Tenants', href: '/dashboard/admin/tenants'}} />
